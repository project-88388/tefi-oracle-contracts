...
var createWasmExecMethodPartial = function createWasmExecMethodPartial(jsonschema) {
  ...
  var constantParams = [(0, _babel.identifier)("funds", t.tsTypeAnnotation((0, _babel.tsTypeOperator)(t.tsArrayType(t.tsTypeReference(t.identifier("Coin"))), "readonly")), true)];
