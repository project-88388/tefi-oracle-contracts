...
var convertToQueryMethod = function convertToQueryMethod(name) {
  return "".concat((0, _case.camel)(name), "Query");
};

exports.convertToQueryMethod = convertToQueryMethod;
