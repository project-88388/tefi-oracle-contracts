...
var Wallet = /** @class */ (function () {
    ...
    Wallet.prototype.accountNumberAndSequence = function (chainID) {
    ...
    Wallet.prototype.accountNumber = function (chainID) {
        return this.lcd.auth
            .accountInfo(this.key.accAddress(this.lcd.config[chainID].prefix))
            .then(function (d) {
    ...
    Wallet.prototype.sequence = function (chainID) {
        return this.lcd.auth
            .accountInfo(this.key.accAddress(this.lcd.config[chainID].prefix))
            .then(function (d) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.accountNumberAndSequence(options.chainID)];
                    case 1:
                        res = _a.sent();
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, this.key.signTx(tx, {
                                ...
                                signMode: options.signMode ||
                                    (options.msgs.find(function (m) { return m instanceof core_1.MsgAminoCustom; })
                                        ? signing_2.SignMode.SIGN_MODE_LEGACY_AMINO_JSON
