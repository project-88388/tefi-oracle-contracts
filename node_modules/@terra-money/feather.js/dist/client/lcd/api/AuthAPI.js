...
var AuthAPI = /** @class */ (function (_super) {
     ...
     */
    AuthAPI.prototype.moduleAccountInfo = function (chainID, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var accounts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getReqFromChainID(chainID).get("/cosmos/auth/v1beta1/module_accounts", params)];
                    case 1:
                        accounts = (_a.sent()).accounts;
                        return [2 /*return*/, accounts.map(function (account) { return core_1.Account.fromData(account); })];
                }
            });
        });
    };
    ...
    AuthAPI.prototype.accountInfo = function (address, params) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getReqFromAddress(address).get("/cosmos/auth/v1beta1/accounts/".concat(address), params)];
                    case 1:
    ...
    AuthAPI.prototype.parameters = function (chainID, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
