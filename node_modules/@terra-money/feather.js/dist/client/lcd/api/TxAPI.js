...
var TxAPI = /** @class */ (function (_super) {
     ...
     */
    TxAPI.prototype.txInfo = function (txHash, chainID, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getReqFromChainID(chainID)
     ...
     */
    TxAPI.prototype.txInfosByHeight = function (chainID, height) {
        return __awaiter(this, void 0, void 0, function () {
            var blockInfo, txs, txhashes, txInfos, _i, txhashes_1, txhash, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.lcd.tendermint.blockInfo(chainID, height)];
                    case 1:
                        blockInfo = _c.sent();
                    ...
                    case 3:
                        ...
                        _b = (_a = txInfos).push;
                        return [4 /*yield*/, this.txInfo(txhash, chainID)];
                    case 4:
                        _b.apply(_a, [_c.sent()]);
                        _c.label = 5;
                    case 5:
    ...
    TxAPI.prototype.estimateFee = function (signers, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        gasPrices = options.gasPrices || this.lcd.config[options.chainID].gasPrices;
                        gasAdjustment = options.gasAdjustment || this.lcd.config[options.chainID].gasAdjustment;
                        ...
                        return [4 /*yield*/, this.estimateGas(tx, options.chainID, { gasAdjustment: gasAdjustment })];
                    case 1:
                    ...
                    case 2:
                        feeAmount = gasPricesCoins
                            ...
                            : "0".concat(Object.keys(gasPrices)[0]);
                        return [2 /*return*/, new core_1.Fee(Number.parseInt(gas), feeAmount, '', '')];
                }
            });
        });
    };
    TxAPI.prototype.estimateGas = function (tx, chainID, options) {
        return __awaiter(this, void 0, void 0, function () {
            var gasAdjustment, simTx, authInfo, simulateRes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        gasAdjustment = (options === null || options === void 0 ? void 0 : options.gasAdjustment) || this.lcd.config[chainID].gasAdjustment;
                        simTx = tx;
                        ...
                        return [4 /*yield*/, this.getReqFromChainID(chainID)
     ...
     */
    TxAPI.prototype.encode = function (tx, isClassic) {
    ...
    TxAPI.prototype._broadcast = function (tx, mode, chainID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getReqFromChainID(chainID).post("/cosmos/tx/v1beta1/txs", {
     ...
     */
    TxAPI.prototype.broadcast = function (tx, chainID, timeout) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        POLL_INTERVAL = 500;
                        return [4 /*yield*/, this._broadcast(tx, 'BROADCAST_MODE_SYNC', chainID)];
                    case 1:
                    ...
                    case 3:
                        _a.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, this.txInfo(txResponse.txhash, chainID)];
                    case 4:
                        txInfo = _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
     ...
     * @param chainID chain ID
     */
    TxAPI.prototype.broadcastBlock = function (tx, chainID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._broadcast(tx, 'BROADCAST_MODE_BLOCK', chainID).then(function (_a) {
     ...
     * @param chainID chain ID
     */
    TxAPI.prototype.broadcastSync = function (tx, chainID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._broadcast(tx, 'BROADCAST_MODE_SYNC', chainID).then(function (_a) {
                        var d = _a.tx_response;
                        var blockResult = {
                            height: +d.height,
                            txhash: d.txhash,
     ...
     * @param chainID chain ID
     */
    TxAPI.prototype.broadcastAsync = function (tx, chainID) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._broadcast(tx, 'BROADCAST_MODE_ASYNC', chainID).then(function (_a) {
                        var d = _a.tx_response;
                        return ({
                            height: +d.height,
                            txhash: d.txhash,
     ...
     * @param chainID chain ID
     */
    TxAPI.prototype.search = function (options, chainID) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var params;
