...
export declare class UpgradeAPI extends BaseAPI {
     ...
     */
    appliedPlan(name: string, chainID: string, params?: Partial<PaginationOptions & APIParams>): Promise<number>;
    /**
     * Look up the current plan
     */
    currentPlan(chainID: string, params?: APIParams): Promise<Plan | null>;
    /**
     * Look up the versions of the modules
     */
    moduleVersions(chainID: string, params?: APIParams): Promise<ModuleVersion[]>;
}
