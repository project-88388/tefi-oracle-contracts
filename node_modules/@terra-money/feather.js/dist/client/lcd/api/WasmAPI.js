...
var WasmAPI = /** @class */ (function (_super) {
    ...
    WasmAPI.prototype.codeInfo = function (codeID, chainID, params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, this.getReqFromAddress(contractAddress)
                                .get(endpoint, params)
                                .then(function (_a) {
    ...
    WasmAPI.prototype.parameters = function (chainID, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getReqFromChainID(chainID)
    ...
    WasmAPI.prototype.pinnedCodes = function (chainID, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getReqFromChainID(chainID)
    ...
    WasmAPI.prototype.allCodes = function (chainID, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getReqFromChainID(chainID)
