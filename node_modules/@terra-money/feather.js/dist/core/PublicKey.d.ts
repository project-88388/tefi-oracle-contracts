...
export declare type PublicKey = SimplePublicKey | LegacyAminoMultisigPublicKey | ValConsPublicKey | InjectivePubKey;
...
export declare class InjectivePubKey extends JSONSerializable<InjectivePubKey.Amino, InjectivePubKey.Data, InjectivePubKey.Proto> {
    ...
    packAny(): Any;
    static unpackAny(pubkeyAny: Any): InjectivePubKey;
    encodeAminoPubkey(): Uint8Array;
