...
exports.ValConsPublicKey = exports.LegacyAminoMultisigPublicKey = exports.InjectivePubKey = exports.SimplePublicKey = exports.PublicKey = void 0;
...
var SimplePublicKey = /** @class */ (function (_super) {
    ...
    SimplePublicKey.prototype.address = function (prefix) {
        return bech32_1.bech32.encode(prefix, bech32_1.bech32.toWords(this.rawAddress()));
    };
    SimplePublicKey.prototype.pubkeyAddress = function (prefix) {
        return bech32_1.bech32.encode("".concat(prefix, "pub"), bech32_1.bech32.toWords(this.encodeAminoPubkey()));
    };
    return SimplePublicKey;
}(json_1.JSONSerializable));
exports.SimplePublicKey = SimplePublicKey;
var InjectivePubKey = /** @class */ (function (_super) {
    __extends(InjectivePubKey, _super);
    function InjectivePubKey(key) {
        var _this = _super.call(this) || this;
        _this.key = key;
        return _this;
    }
    InjectivePubKey.fromAmino = function (data) {
        return new InjectivePubKey(data.value);
    };
    InjectivePubKey.prototype.toAmino = function () {
        return {
            type: 'tendermint/PubKeySecp256k1',
            value: this.key,
        };
    };
    InjectivePubKey.fromData = function (data) {
        return new InjectivePubKey(data.key);
    };
    InjectivePubKey.prototype.toData = function () {
        return {
            '@type': '/injective.crypto.v1beta1.ethsecp256k1.PubKey',
            key: this.key,
        };
    };
    InjectivePubKey.fromProto = function (pubkeyProto) {
        return new InjectivePubKey(Buffer.from(pubkeyProto.key).toString('base64'));
    };
    InjectivePubKey.prototype.toProto = function () {
        return keys_2.PubKey.fromPartial({
            key: Buffer.from(this.key, 'base64'),
        });
    };
    InjectivePubKey.prototype.packAny = function () {
        return any_1.Any.fromPartial({
            typeUrl: '/injective.crypto.v1beta1.ethsecp256k1.PubKey',
            value: keys_2.PubKey.encode(this.toProto()).finish(),
        });
    };
    InjectivePubKey.unpackAny = function (pubkeyAny) {
        return InjectivePubKey.fromProto(keys_2.PubKey.decode(pubkeyAny.value));
    };
    InjectivePubKey.prototype.encodeAminoPubkey = function () {
        return Buffer.concat([
            pubkeyAminoPrefixSecp256k1,
            Buffer.from(this.key, 'base64'),
        ]);
    };
    InjectivePubKey.prototype.rawEthAddress = function () {
        var pubkeyData = Buffer.from(this.key, 'base64');
        var fixedPubKey = new Uint8Array(Buffer.from((pubkeyData.length === 64 ? '04' : '') + pubkeyData.toString('hex'), 'hex'));
        var decompressedPublicKey = Buffer.from((0, secp256k1_1.publicKeyConvert)(fixedPubKey, false)).toString('hex');
        var addressBuffer = Buffer.from((0, utils_1.keccak256)(Buffer.from(decompressedPublicKey.substring(2), 'hex')).replace('0x', ''), 'hex').subarray(-20);
        return addressBuffer;
    };
    InjectivePubKey.prototype.address = function (prefix) {
        return bech32_1.bech32.encode(prefix, bech32_1.bech32.toWords(this.rawEthAddress()));
    };
    InjectivePubKey.prototype.pubkeyAddress = function (prefix) {
        return bech32_1.bech32.encode("".concat(prefix, "pub"), bech32_1.bech32.toWords(this.encodeAminoPubkey()));
    };
    return InjectivePubKey;
}(json_1.JSONSerializable));
exports.InjectivePubKey = InjectivePubKey;
var LegacyAminoMultisigPublicKey = /** @class */ (function (_super) {
    ...
    LegacyAminoMultisigPublicKey.prototype.address = function (prefix) {
        return bech32_1.bech32.encode(prefix, bech32_1.bech32.toWords(this.rawAddress()));
    };
    LegacyAminoMultisigPublicKey.prototype.pubkeyAddress = function (prefix) {
        return bech32_1.bech32.encode("".concat(prefix, "pub"), bech32_1.bech32.toWords(this.encodeAminoPubkey()));
    };
...
var ValConsPublicKey = /** @class */ (function (_super) {
    ...
    ValConsPublicKey.prototype.address = function (prefix) {
        return bech32_1.bech32.encode("".concat(prefix, "valcons"), bech32_1.bech32.toWords(this.rawAddress()));
    };
    ValConsPublicKey.prototype.pubkeyAddress = function (prefix) {
        return bech32_1.bech32.encode("".concat(prefix, "valconspub"), bech32_1.bech32.toWords(this.encodeAminoPubkey()));
    };
