...
var EthAccount_1 = require("./EthAccount");
/**
...
(function (Account) {
    function fromAmino(amino, isClassic) {
        switch (amino.type) {
            ...
            case 'cosmos-sdk/ModuleAccount':
                return ModuleAccount_1.ModuleAccount.fromAmino(amino, isClassic);
            case 'injective/EthAccount':
                return EthAccount_1.EthAccount.fromAmino(amino, isClassic);
        }
    }
    ...
    function fromData(data, isClassic) {
        switch (data['@type']) {
            ...
            case '/cosmos.auth.v1beta1.ModuleAccount':
                return ModuleAccount_1.ModuleAccount.fromData(data, isClassic);
            case '/injective.types.v1beta1.EthAccount':
                return EthAccount_1.EthAccount.fromData(data, isClassic);
        }
    }
    ...
    function fromProto(accountAny, isClassic) {
        ...
        if (typeUrl === '/cosmos.auth.v1beta1.BaseAccount') {
            ...
            return ModuleAccount_1.ModuleAccount.unpackAny(accountAny, isClassic);
        }
