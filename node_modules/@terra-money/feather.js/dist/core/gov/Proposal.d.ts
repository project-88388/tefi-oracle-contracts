...
import { MsgCreateAllianceProposal, MsgDeleteAllianceProposal, MsgUpdateAllianceProposal } from '../../core/alliance/proposals';
/**
...
export declare class Proposal extends JSONSerializable<Proposal.Amino, Proposal.Data, Proposal.Proto> {
     ...
     */
    constructor(id: number, content: Proposal.Content | undefined, status: ProposalStatus, final_tally_result: Proposal.FinalTallyResult, submit_time: Date, deposit_end_time: Date, total_deposit: Coins, voting_start_time: Date, voting_end_time: Date);
...
export declare namespace Proposal {
    ...
    namespace Content {
        ...
        function fromAmino(amino: Proposal.Content.Amino, isClassic?: boolean): Proposal.Content | undefined;
        function fromData(data: Proposal.Content.Data, isClassic?: boolean): Proposal.Content | undefined;
