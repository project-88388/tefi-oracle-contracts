...
var proposals_7 = require("../../core/alliance/proposals");
/**
...
var Proposal = /** @class */ (function (_super) {
    ...
    Proposal.prototype.toAmino = function (isClassic) {
        var _a;
        var _b = this, status = _b.status, final_tally_result = _b.final_tally_result;
        return {
            id: this.id.toFixed(),
            content: (_a = this.content) === null || _a === void 0 ? void 0 : _a.toAmino(isClassic),
            status: status,
            final_tally_result: {
    ...
    Proposal.prototype.toData = function (isClassic) {
        ...
        return {
            ...
            content: (_a = this.content) === null || _a === void 0 ? void 0 : _a.toData(isClassic),
    ...
    Proposal.prototype.toProto = function (isClassic) {
        ...
        return gov_1.Proposal.fromPartial({
            proposalId: long_1.default.fromNumber(this.id),
            content: (_a = this.content) === null || _a === void 0 ? void 0 : _a.packAny(isClassic),
            status: status,
    ...
    (function (Content) {
        function fromAmino(amino, isClassic) {
            ...
            switch (amino.type) {
                ...
                case 'alliance/MsgCreateAllianceProposal':
                    return proposals_7.MsgCreateAllianceProposal.fromAmino(amino, isClassic);
                case 'alliance/MsgUpdateAllianceProposal':
                    return proposals_7.MsgUpdateAllianceProposal.fromAmino(amino, isClassic);
                case 'alliance/MsgDeleteAllianceProposal':
                    return proposals_7.MsgDeleteAllianceProposal.fromAmino(amino, isClassic);
            }
        }
        ...
        function fromData(data, isClassic) {
            ...
            switch (data['@type']) {
                ...
                case '/alliance.alliance.MsgCreateAllianceProposal':
                    return proposals_7.MsgCreateAllianceProposal.fromData(data, isClassic);
                case '/alliance.alliance.MsgUpdateAllianceProposal':
                    return proposals_7.MsgUpdateAllianceProposal.fromData(data, isClassic);
                case '/alliance.alliance.MsgDeleteAllianceProposal':
                    return proposals_7.MsgDeleteAllianceProposal.fromData(data, isClassic);
            }
        }
        ...
        function fromProto(anyProto, isClassic) {
            ...
            switch (typeUrl) {
                ...
                case '/alliance.alliance.MsgCreateAllianceProposal':
                    return proposals_7.MsgCreateAllianceProposal.unpackAny(anyProto, isClassic);
                case '/alliance.alliance.MsgUpdateAllianceProposal':
                    return proposals_7.MsgUpdateAllianceProposal.unpackAny(anyProto, isClassic);
                case '/alliance.alliance.MsgDeleteAllianceProposal':
                    return proposals_7.MsgDeleteAllianceProposal.unpackAny(anyProto, isClassic);
            }
