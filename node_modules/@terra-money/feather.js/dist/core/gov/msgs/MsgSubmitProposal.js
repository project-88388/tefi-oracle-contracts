...
var MsgSubmitProposal = /** @class */ (function (_super) {
    ...
    MsgSubmitProposal.fromAmino = function (data, isClassic) {
        ...
        // @ts-expect-error
        Proposal_1.Proposal.Content.fromAmino(content, isClassic), Coins_1.Coins.fromAmino(initial_deposit), proposer);
    };
    ...
    MsgSubmitProposal.fromData = function (data, isClassic) {
        ...
        return new MsgSubmitProposal(
        // @ts-expect-error
        Proposal_1.Proposal.Content.fromData(content, isClassic), Coins_1.Coins.fromData(initial_deposit), proposer);
    };
