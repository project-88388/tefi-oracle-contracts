...
var MsgTransfer = /** @class */ (function (_super) {
    ...
    MsgTransfer.fromAmino = function (data, _) {
        ...
        return new MsgTransfer(source_port, source_channel, token ? Coin_1.Coin.fromAmino(token) : undefined, sender, receiver, timeout_height ? Height_1.Height.fromAmino(timeout_height) : undefined, timeout_timestamp ? numeric_1.Numeric.parse(timeout_timestamp) : undefined, memo);
    };
    ...
    MsgTransfer.fromData = function (data, _) {
        ...
        return new MsgTransfer(source_port, source_channel, token ? Coin_1.Coin.fromData(token) : undefined, sender, receiver, timeout_height ? Height_1.Height.fromData(timeout_height) : undefined, timeout_timestamp ? Number.parseInt(timeout_timestamp) : undefined, memo);
    };
    ...
    MsgTransfer.fromProto = function (proto, _) {
        ...
        return new MsgTransfer(proto.sourcePort, proto.sourceChannel, proto.token ? Coin_1.Coin.fromProto(proto.token) : undefined, proto.sender, proto.receiver, proto.timeoutHeight ? Height_1.Height.fromProto(proto.timeoutHeight) : undefined, proto.timeoutTimestamp.toNumber(), proto.memo);
    };
    MsgTransfer.prototype.toProto = function (_) {
        ...
        return tx_1.MsgTransfer.fromPartial({
            ...
            timeoutTimestamp: long_1.default.fromString((timeout_timestamp === null || timeout_timestamp === void 0 ? void 0 : timeout_timestamp.toFixed()) || '0'),
            memo: memo,
        });
    };
