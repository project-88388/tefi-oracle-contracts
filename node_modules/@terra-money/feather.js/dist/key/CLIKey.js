...
var CLIKey = /** @class */ (function (_super) {
     ...
     * Account address.
     */
    CLIKey.prototype.accAddress = function (prefix) {
        if (!this._accAddress) {
     ...
     */
    CLIKey.prototype.valAddress = function (prefix) {
        if (!this._accAddress) {
            this.loadAccountDetails();
            return this.valAddress(prefix);
        }
        return bech32_1.ValAddress.fromAccAddress(this._accAddress, prefix);
    };
