...
var Key = /** @class */ (function () {
     ...
     * Account address.
     */
    Key.prototype.accAddress = function (prefix) {
        if (!this.publicKey) {
     ...
     * Validator address.
     */
    Key.prototype.valAddress = function (prefix) {
        if (!this.publicKey) {
            throw new Error('Could not compute valAddress: missing rawAddress');
        }
        return this.publicKey.address("".concat(prefix, "valoper"));
    };
    /**
    ...
    Key.prototype.createSignatureAmino = function (tx, isClassic) {
        return __awaiter(this, void 0, void 0, function () {
            var isEthereum, publicKey, _a, _b, _c, _d, _e, _f, _g;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        ...
                        isEthereum = tx.chain_id.startsWith('injective-');
                        publicKey = isEthereum
                            ? // @ts-expect-error
                                core_1.InjectivePubKey.fromData(this.publicKey)
                            : this.publicKey;
                        ...
                        return [4 /*yield*/, this.sign(Buffer.from(tx.toAminoJSON(isClassic)), isEthereum)];
    ...
    Key.prototype.createSignature = function (signDoc, isClassic) {
        return __awaiter(this, void 0, void 0, function () {
            var isEthereum, publicKey, signerInfos, sigBytes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        isEthereum = signDoc.chain_id.startsWith('injective-');
                        publicKey = isEthereum
                            ? // @ts-expect-error
                                core_1.InjectivePubKey.fromData(this.publicKey)
                            : this.publicKey;
                        ...
                        signDoc.auth_info.signer_infos = [
                            new core_1.SignerInfo(publicKey, signDoc.sequence, new core_1.ModeInfo(new core_1.ModeInfo.Single(signing_1.SignMode.SIGN_MODE_DIRECT))),
                        ];
                        return [4 /*yield*/, this.sign(Buffer.from(signDoc.toBytes(isClassic)), isEthereum)];
                    case 1:
                        sigBytes = (_a.sent()).toString('base64');
                        // restore signDoc to origin
                        signDoc.auth_info.signer_infos = signerInfos;
                        return [2 /*return*/, new SignatureV2_1.SignatureV2(publicKey, new SignatureV2_1.SignatureV2.Descriptor(new SignatureV2_1.SignatureV2.Descriptor.Single(signing_1.SignMode.SIGN_MODE_DIRECT, sigBytes)), signDoc.sequence)];
                }
            });
        });
    };
