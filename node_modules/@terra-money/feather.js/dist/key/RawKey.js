...
var BytesUtils = __importStar(require("@ethersproject/bytes"));
...
var RawKey = /** @class */ (function (_super) {
    ...
    function RawKey(privateKey, isInjective) {
        var _this = this;
        var publicKey = secp256k1.publicKeyCreate(new Uint8Array(privateKey), true);
        _this = _super.call(this, isInjective
            ? new PublicKey_1.InjectivePubKey(Buffer.from(publicKey).toString('base64'))
            : new PublicKey_1.SimplePublicKey(Buffer.from(publicKey).toString('base64'))) || this;
        _this.isInjective = isInjective;
    ...
    RawKey.prototype.etherSign = function (payload) {
        var hash = (0, keccak256_1.default)(payload);
        var wallet = new ethers_1.Wallet(this.privateKey);
        var signature = wallet._signingKey().signDigest(hash);
        return {
            signature: BytesUtils.arrayify(BytesUtils.concat([signature.r, signature.s])),
        };
    };
    RawKey.prototype.sign = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                signature = (this.isInjective
                    ? this.etherSign(payload)
                    : this.ecdsaSign(payload)).signature;
