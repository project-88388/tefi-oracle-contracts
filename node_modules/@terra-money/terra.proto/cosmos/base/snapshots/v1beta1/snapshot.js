...
exports.SnapshotItem = {
    ...
    fromJSON(object) {
        ...
        if (object.kv !== undefined && object.kv !== null) {
            message.kv = exports.SnapshotKVItem.fromJSON(object.kv);
        }
        else {
            message.kv = undefined;
        }
        if (object.schema !== undefined && object.schema !== null) {
            message.schema = exports.SnapshotSchema.fromJSON(object.schema);
        }
        else {
...
exports.SnapshotKVItem = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseSnapshotKVItem);
        message.key = new Uint8Array();
        message.value = new Uint8Array();
        while (reader.pos < end) {
            const tag = reader.uint32();
...
exports.SnapshotSchema = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseSnapshotSchema);
        message.keys = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
