...
const baseGetTxsEventRequest = { events: "", orderBy: 0, page: long_1.default.UZERO, limit: long_1.default.UZERO };
exports.GetTxsEventRequest = {
    ...
    fromJSON(object) {
        ...
        if (object.page !== undefined && object.page !== null) {
            message.page = long_1.default.fromString(object.page);
        }
        else {
            message.page = long_1.default.UZERO;
        }
    ...
    toJSON(message) {
        ...
        message.page !== undefined && (obj.page = (message.page || long_1.default.UZERO).toString());
...
const baseGetTxsEventResponse = { total: long_1.default.UZERO };
