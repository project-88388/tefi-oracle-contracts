...
const baseSignDocDirectAux = { chainId: "", accountNumber: long_1.default.UZERO, sequence: long_1.default.UZERO };
exports.SignDocDirectAux = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseSignDocDirectAux);
        message.bodyBytes = new Uint8Array();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
    ...
    fromJSON(object) {
        ...
        if (object.tip !== undefined && object.tip !== null) {
            message.tip = exports.Tip.fromJSON(object.tip);
        }
        else {
...
exports.Tip = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseTip);
        message.amount = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
const baseAuxSignerData = { address: "", mode: 0 };
exports.AuxSignerData = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseAuxSignerData);
    ...
    fromJSON(object) {
        ...
        if (object.signDoc !== undefined && object.signDoc !== null) {
            message.signDoc = exports.SignDocDirectAux.fromJSON(object.signDoc);
        }
        else {
