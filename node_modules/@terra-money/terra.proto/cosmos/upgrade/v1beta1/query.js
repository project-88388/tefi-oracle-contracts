...
const baseQueryAuthorityRequest = {};
exports.QueryAuthorityRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseQueryAuthorityRequest);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseQueryAuthorityResponse = { address: "" };
exports.QueryAuthorityResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseQueryAuthorityResponse);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.QueryAuthorityDesc = {
    ...
    responseType: {
        deserializeBinary(data) {
            return Object.assign(Object.assign({}, exports.QueryAuthorityResponse.decode(data)), { toObject() {
                    return this;
                } });
        },
    },
