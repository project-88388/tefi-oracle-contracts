...
const baseMsgCreatePermanentLockedAccount = { fromAddress: "", toAddress: "" };
exports.MsgCreatePermanentLockedAccount = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseMsgCreatePermanentLockedAccount);
        message.amount = [];
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
const baseMsgCreatePermanentLockedAccountResponse = {};
exports.MsgCreatePermanentLockedAccountResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseMsgCreatePermanentLockedAccountResponse);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
exports.MsgCreatePermanentLockedAccountDesc = {
    ...
    responseType: {
        deserializeBinary(data) {
            return Object.assign(Object.assign({}, exports.MsgCreatePermanentLockedAccountResponse.decode(data)), { toObject() {
                    return this;
                } });
        },
    },
