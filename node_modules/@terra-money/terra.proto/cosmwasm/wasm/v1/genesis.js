...
exports.Contract = {
    ...
    fromJSON(object) {
        ...
        if (object.contractCodeHistory !== undefined && object.contractCodeHistory !== null) {
            for (const e of object.contractCodeHistory) {
                message.contractCodeHistory.push(types_1.ContractCodeHistoryEntry.fromJSON(e));
            }
        }
        return message;
    },
    ...
    fromPartial(object) {
        ...
        if (object.contractCodeHistory !== undefined && object.contractCodeHistory !== null) {
            for (const e of object.contractCodeHistory) {
                message.contractCodeHistory.push(types_1.ContractCodeHistoryEntry.fromPartial(e));
            }
        }
        return message;
    },
