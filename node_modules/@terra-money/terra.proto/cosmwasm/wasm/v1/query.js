...
const baseQueryContractsByCreatorRequest = { creatorAddress: "" };
exports.QueryContractsByCreatorRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseQueryContractsByCreatorRequest);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseQueryContractsByCreatorResponse = { contractAddresses: "" };
exports.QueryContractsByCreatorResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseQueryContractsByCreatorResponse);
...
exports.QueryContractsByCreatorDesc = {
    ...
    responseType: {
        deserializeBinary(data) {
            return Object.assign(Object.assign({}, exports.QueryContractsByCreatorResponse.decode(data)), { toObject() {
                    return this;
                } });
        },
    },
