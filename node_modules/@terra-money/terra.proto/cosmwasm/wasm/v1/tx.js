...
const baseMsgInstantiateContract2 = {
    sender: "",
    admin: "",
...
exports.MsgInstantiateContract2 = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseMsgInstantiateContract2);
        message.funds = [];
        message.msg = new Uint8Array();
...
const baseMsgInstantiateContract2Response = { address: "" };
exports.MsgInstantiateContract2Response = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseMsgInstantiateContract2Response);
        message.data = new Uint8Array();
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
...
exports.MsgInstantiateContract2Desc = {
    ...
    responseType: {
        deserializeBinary(data) {
            return Object.assign(Object.assign({}, exports.MsgInstantiateContract2Response.decode(data)), { toObject() {
                    return this;
                } });
        },
    },
