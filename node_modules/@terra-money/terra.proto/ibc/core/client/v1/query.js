...
exports.QueryConsensusStateHeightsResponse = {
    ...
    fromJSON(object) {
        ...
        if (object.consensusStateHeights !== undefined && object.consensusStateHeights !== null) {
            for (const e of object.consensusStateHeights) {
                message.consensusStateHeights.push(client_1.Height.fromJSON(e));
            }
        }
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromJSON(object.pagination);
    ...
    fromPartial(object) {
        ...
        if (object.consensusStateHeights !== undefined && object.consensusStateHeights !== null) {
            for (const e of object.consensusStateHeights) {
                message.consensusStateHeights.push(client_1.Height.fromPartial(e));
            }
        }
        if (object.pagination !== undefined && object.pagination !== null) {
            message.pagination = pagination_1.PageResponse.fromPartial(object.pagination);
...
exports.QueryConsensusStateHeightsDesc = {
    ...
    responseType: {
        deserializeBinary(data) {
            return Object.assign(Object.assign({}, exports.QueryConsensusStateHeightsResponse.decode(data)), { toObject() {
                    return this;
                } });
        },
    },
