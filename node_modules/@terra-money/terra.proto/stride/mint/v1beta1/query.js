...
exports.GrpcWebImpl = exports.QueryEpochProvisionsDesc = exports.QueryParamsDesc = exports.QueryDesc = exports.QueryClientImpl = exports.QueryEpochProvisionsResponse = exports.QueryEpochProvisionsRequest = exports.QueryParamsResponse = exports.QueryParamsRequest = exports.protobufPackage = void 0;
/* eslint-disable */
const long_1 = __importDefault(require("long"));
const grpc_web_1 = require("@improbable-eng/grpc-web");
const minimal_1 = __importDefault(require("protobufjs/minimal"));
const mint_1 = require("../../../stride/mint/v1beta1/mint");
...
const baseQueryEpochProvisionsRequest = {};
exports.QueryEpochProvisionsRequest = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseQueryEpochProvisionsRequest);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                default:
...
const baseQueryEpochProvisionsResponse = {};
exports.QueryEpochProvisionsResponse = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseQueryEpochProvisionsResponse);
    ...
    toJSON(message) {
        ...
        message.epochProvisions !== undefined &&
            (obj.epochProvisions = base64FromBytes(message.epochProvisions !== undefined ? message.epochProvisions : new Uint8Array()));
        return obj;
    },
    fromPartial(object) {
        const message = Object.assign({}, baseQueryEpochProvisionsResponse);
...
class QueryClientImpl {
    ...
    EpochProvisions(request, metadata) {
        return this.rpc.unary(exports.QueryEpochProvisionsDesc, exports.QueryEpochProvisionsRequest.fromPartial(request), metadata);
    }
}
...
exports.QueryEpochProvisionsDesc = {
    ...
    requestType: {
        serializeBinary() {
            return exports.QueryEpochProvisionsRequest.encode(this).finish();
        },
    },
    responseType: {
        deserializeBinary(data) {
            return Object.assign(Object.assign({}, exports.QueryEpochProvisionsResponse.decode(data)), { toObject() {
                    return this;
                } });
        },
    },
