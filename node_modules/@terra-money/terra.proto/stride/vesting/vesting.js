...
exports.StridePeriodicVestingAccount = exports.Period = exports.BaseVestingAccount = exports.protobufPackage = void 0;
/* eslint-disable */
const long_1 = __importDefault(require("long"));
const minimal_1 = __importDefault(require("protobufjs/minimal"));
const auth_1 = require("../../cosmos/auth/v1beta1/auth");
const coin_1 = require("../../cosmos/base/v1beta1/coin");
exports.protobufPackage = "stride.vesting";
...
const basePeriod = { startTime: long_1.default.ZERO, length: long_1.default.ZERO, actionType: 0 };
exports.Period = {
    encode(message, writer = minimal_1.default.Writer.create()) {
...
const baseStridePeriodicVestingAccount = {};
exports.StridePeriodicVestingAccount = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseStridePeriodicVestingAccount);
